...
The relationship between 1/_f_ noise slope and age replicated ([Figure 1](#fig-slope-age), `r age.slope.cor`).

```{r, echo=FALSE, fig.width=3.5, fig.height=2.5, fig.align='left', fig.cap="Relationship between 1/f noise during a sensorimotor task and age."}
...
There was however no evidence for a relationship between 1/_f_ noise and visual short term memory ([Figure 2](#fig-slope-rt), `r vstm.slope.cor`) or visual short-term memory (`r rt.slope.cor`).
...
```{r, echo=FALSE, fig.width=3.3, fig.height=2.5, warning=FALSE, eval=FALSE, fig.cap="No relationship between 1/f noise and reaction times."}
...
```{r, echo=FALSE, fig.width=3.3, fig.height=2.5, warning=FALSE, eval=FALSE, fig.cap="No relationship between 1/f noise and short-term memory."}
p <- task.data %>%
  filter(Prcsn_ss4 <= 1) %>%
...
```{r, echo=FALSE, fig.width=3.3, fig.height=2.6, fig.cap="Power spectra in the top and bottom age quartiles."}
