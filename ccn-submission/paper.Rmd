...
There was no evidence for a relationship between 1/_f_ noise slope and age (Figure 1, `r age.slope.cor`). There was also no evidence for a relationship between 1/_f_ noise and sensorimotor reaction times (Figure 2, `r rt.slope.cor`) or visual short-term memory (`r vstm.slope.cor`).
...
p
```
_Figure 1: No relationship between 1/f noise and age._
...
p
```
_Figure 2: No relationship between 1/f noise and reaction times._
