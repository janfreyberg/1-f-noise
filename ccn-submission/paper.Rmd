---
title: "No relationship between age and 1/_f_ noise in 170 MEG datasets"
author: "Jan Freyberg"
...
There was no evidence for a relationship between 1/_f_ noise slope and age ([Figure 1](#fig-slope-age), `r age.slope.cor`). There was also no evidence for a relationship between 1/_f_ noise and sensorimotor reaction times ([Figure 2](#fig-slope-rt), `r rt.slope.cor`) or visual short-term memory (`r vstm.slope.cor`).
...
###### _Figure 1: No relationship between 1/f noise and age._ {#fig-slope-age}
...
###### _Figure 3: Equivalent power spectra in the top and bottom age quartiles._ {#fig-spectrum}
